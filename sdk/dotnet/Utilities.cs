...
namespace HcloudUploadImage.HcloudUploadImage
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/exivity";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("HcloudUploadImage.HcloudUploadImage.version.txt");
    ...
    internal sealed class HcloudUploadImageResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HcloudUploadImageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
